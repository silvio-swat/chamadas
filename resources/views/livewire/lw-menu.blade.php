    ...
    <div class="py-3 ">
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  <tr class="bg-emerald-200">
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <button wire:click="edit({{$menuPage->id}})">Edit</button>
                        {{-- <a href="#" wire:click="edit({{$menu->id}})" class="text-indigo-600 hover:text-indigo-900">Edit</a> --}}
                      </td>  
                      <td class="px-6 py-4 whitespace-nowrap">
                        <button wire:click="delete({{$menuPage->id}})">X</button>
      ...
      <div x-data="{ openTab: 1 }" class="p-6">
        ...
        <div class="w-full pt-4">
          @foreach($menuPages as $menuPage)        
            <div x-show="openTab === {{$menuPage->id}}">{{$menuPage->name}}</div>
          @endforeach 
        </div>
      </div>
        ...
        id="modal_overlay" class="absolute inset-0 bg-black bg-opacity-30 h-screen w-full flex justify-center items-start md:items-center pt-10 md:pt-0">
          ...
          class="pacity-0 transform relative w-10/10 md:w-1/3 h-1/2 md:h-3/4 bg-white rounded shadow-lg">
              ...
              <div class="w-full p-20">
                ...
                <form class="w-full max-w-lg" wire:submit.prevent="submit({{$menuPageModel}})">
                    <div class="flex flex-wrap -mx-3 mb-6">
                      <div class="w-full px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
                          Nome Exibição
                        </label>
                        <input wire:model="menuPageModel.name" class="appearance-none block w-full bg-gray-200 text-gray-700 border
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                      <div class="w-full px-3">
                        ...
                        <input wire:model="menuPageModel.order" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="numeric" placeholder="Aplicado para os usuários">
